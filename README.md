...
Без слов `создай` или `опубликуй` скилл показывает результат только в чате. Для создания должны быть указаны проект и существующая папка; неизвестную папку инструмент не придумывает и не создаёт.
...
- Изменения существующих кейсов остаются read-only: инструмент показывает предложение, но не применяет его в TMS.
