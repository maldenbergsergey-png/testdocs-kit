...
- [`good/admin-entity-and-frontend-consumer-ru.md`](good/admin-entity-and-frontend-consumer-ru.md) - a compact administration creation case ending with saved fields and relations in the admin UI, plus a frontend consumer with a conditional creation link and `ℹ️` requirement/configuration-step hints.
