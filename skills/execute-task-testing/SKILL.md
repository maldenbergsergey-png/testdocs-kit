...
1. Collect the supplied task or component scope, navigation path and source-backed criteria. Infer the platform from context and apply the conditional surface preflight linked by `task-execution-rules.md`.
